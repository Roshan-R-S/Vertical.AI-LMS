          ...
          <div className="form-grid-3">
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, milestone: e.target.value }))
                }
              >
                {milestones.map((m) => (
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, disposition: e.target.value }))
                }
              >
                {milestoneDis.map((d) => (
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, assignedToId: e.target.value }))
                }
                required
              >
          ...
          {lead &&
            ...
            lead.status !== "won" && (
              ...
              >
                ...
                >
                  <div>
                    <h4 style={{ margin: 0, color: "#10b981", fontSize: 14 }}>
                      Ready to finalize?
                    </h4>
                    <p
                      style={{
                    ...
                    >
                      Converting will create a permanent Client profile and move
                      this lead to 'Won'.
                    </p>
                  </div>
                  {!showConvertConfirm ? (
            ...
            {[
              {
                l: "Stage",
                v: lead.milestone,
                c: MILESTONE_COLORS[lead.milestone],
              },
              { l: "Source", v: lead.source, c: "#06b6d4" },
              {
                l: "Score",
                v: lead.score,
                c: lead.score >= 80 ? "#10b981" : "#f59e0b",
              },
              {
                l: "Value",
                v: `₹${(lead.value / 1000).toFixed(0)}K`,
                c: "#6366f1",
              },
              {
                l: "Priority",
                v: lead.priority,
                c: lead.priority === "High" ? "#ef4444" : "#f59e0b",
              },
            ].map((s, i) => (
              <div
                key={i}
                      ...
                      <div className="timeline-content">
                        ...
                        {int.transcript && (
                          ...
                          >
                            ...
                            <span
                              className={`badge ${int.sentiment === "positive" ? "badge-success" : "badge-neutral"}`}
                            >
                              {int.sentiment}
                            </span>
                          </div>
            ...
            <div>
              <div className="form-grid">
                <div className="form-group">
                  ...
                  >
                    {["call", "email", "whatsapp", "meeting"].map((t) => (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                },
                {
                  ...
                  value: `${lead.probability}% probability to close. Expected by ${lead.expectedClose}.`,
                  color: "#10b981",
                },
                {
                  icon: MessageSquare,
                  ...
                  value:
                    "Recent interactions show positive sentiment. Lead is engaged and responsive.",
                  color: "#06b6d4",
                },
                {
                  icon: Star,
                  ...
                  value:
                    "Schedule a follow-up call within 2 days. Share case study from EdTech vertical.",
                  color: "#f59e0b",
                },
              ].map((insight, i) => (
                <div
...
export default function Leads() {
  ...
  const filtered = leads.filter((l) => {
    ...
    return (
      matchSearch && matchMilestone && matchSource && matchBde && matchDate
    );
  });
          ...
          style={{
            ...
            background:
              filterMilestone === "All"
                ...
                : "var(--bg-card)",
            border: `1px solid ${filterMilestone === "All" ? "var(--text-primary)" : "var(--border-subtle)"}`,
            borderRadius: 12,
            padding: "10px 16px",
            cursor: "pointer",
            transition: "all 0.2s",
              ...
              style={{
                ...
                background:
                  filterMilestone === m.name
                    ? `${m.color}20`
                    : "var(--bg-card)",
                border: `1px solid ${filterMilestone === m.name ? m.color : "var(--border-subtle)"}`,
                borderRadius: 12,
                padding: "10px 16px",
                cursor: "pointer",
                transition: "all 0.2s",
        ...
        <div className="table-header">
          ...
          <select
            ...
            style={{
              ...
              padding: "8px 12px",
              fontSize: 13,
              border: filterType === "Untouched" ? "1px solid #f59e0b" : "",
            }}
            value={filterType}
          ...
          {dateRange === "Custom" && (
            ...
            >
              <input
                type="date"
                className="form-input"
                style={{ width: 120, height: 28, fontSize: 11, padding: 4 }}
                    ...
                    <td>
                      <span
                        style={{
                          ...
                          border: `1px solid ${MILESTONE_COLORS[lead.milestone]}40`,
                        }}
                      >
                        {lead.milestone}
                      </span>
                    ...
                    <td>
                      <div className="table-actions">
                        ...
                        <button
                          ...
                          onClick={() =>
                            window.confirm(
                              `Are you sure you want to delete lead "${lead.companyName}"?`,
                            ) && deleteLead(lead.id)
                          }
                        >
                          <Trash2 size={14} />
          ...
          <DndContext sensors={sensors} onDragEnd={handleDragEnd}>
            <div style={{ padding: 16 }}>
              ...
              >
                {milestones
                  .filter(
                    (m) => !["Deal Closed", "Not Interested"].includes(m.name),
                  )
                  .map((m) => {
                    const stageLeads = filtered.filter(
                      (l) => l.milestoneId === m.id,
                    );
                    return (
                      <DroppableColumn
                        key={m.id}
          ...
          {!file ? (
            ...
            <div>
              ...
              >
                <table
                  className="table"
                  style={{ minWidth: "auto", fontSize: 11 }}
                >
                  <thead
                    style={{
                      position: "sticky",
              ...
              >
                {loading
                  ? "Processing..."
                  : `Confirm Import ${preview.length} Leads`}
              </button>
            </div>
          )}
        </div>
